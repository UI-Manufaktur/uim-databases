...
use uim.databases.Schema\MysqlSchemaDialect;
...
class Mysql : Driver
{
     ...
     *
     * @var uim.databases.Schema\MysqlSchemaDialect|null
     */
     ...
     *
     * @return bool
     * @deprecated 4.3.0 Use `supports(IDBADriver::FEATURE_CTE)` instead
     */
     ...
     *
     * @return bool
     * @deprecated 4.3.0 Use `supports(IDBADriver::FEATURE_JSON)` instead
     */
     ...
     *
     * @return bool
     * @deprecated 4.3.0 Use `supports(IDBADriver::FEATURE_WINDOW)` instead
     */
