...
class FunctionsBuilder
{
     ...
     *
     * @param uim.databases\IExpression|string expression the function argument
     ...
     *
     * @param uim.databases\IExpression|string myField Field or expression to cast.
     ...
     * @param uim.databases\IExpression|string expression Expression to obtain the date part from.
     * @param array myTypes list of types to bind to the arguments
     * @return \Cake\Database\Expression\FunctionExpression
     */
     ...
     *
     * @param uim.databases\IExpression|string expression The value evaluated at offset
     ...
     *
     * @param uim.databases\IExpression|string expression function argument
