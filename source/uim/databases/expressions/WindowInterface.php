...
interface WindowInterface
{
     ...
     *
     * @param \Cake\Database\IDTBExpression|\Closure|array<\Cake\Database\IDTBExpression|string>|string $partitions Partition expressions
     * @return $this
     */
     ...
     *
     * @param \Cake\Database\IDTBExpression|\Closure|array<\Cake\Database\IDTBExpression|string>|string $fields Order expressions
     * @return $this
     */
     ...
     *
     * @param \Cake\Database\IDTBExpression|string|int|null $start Frame start
     * @param \Cake\Database\IDTBExpression|string|int|null $end Frame end
     ...
     * @param \Cake\Database\IDTBExpression|string|int|null $startOffset Frame start offset
     * @param string $startDirection Frame start direction
     * @param \Cake\Database\IDTBExpression|string|int|null $endOffset Frame end offset
